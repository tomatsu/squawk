...
/*end[FLOATS]*/	
    ...
    public Set<K> keySet() {
        if (keySet == null)
            keySet = new Collections.SynchronizedSet(new KeySet(), this);
        return keySet;
    }
    ...
    public Set<Map.Entry<K,V>> entrySet() {
        if (entrySet==null)
            entrySet = new Collections.SynchronizedSet(new EntrySet(), this);
        return entrySet;
    }
    ...
    public Collection<V> values() {
        if (values==null)
            values = new Collections.SynchronizedCollection(new ValueCollection(),
                                                        this);
        return values;
    }
