...
builder="${JAVA_HOME}/bin/java $EXTRA_BUILDER_VMFLAGS -XX:CompileCommand=exclude,com/sun/squawk/Method.getParameterTypes -XX:CompileCommand=exclude,com/sun/squawk/SymbolParser.getSignatureTypeAt -XX:CompileCommand=exclude,com/sun/squawk/SymbolParser.stripMethods -Xms128M -Xmx384M -ea -jar build.jar $BUILDER_FLAGS"
#echo $builder
